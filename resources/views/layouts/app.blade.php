...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans bg-gray-background text-gray-900 text-sm">
        ...
        <main class="container max-w-custom mx-auto flex">
            <div class="w-70 mr-5">
                <div class="bg-white border-2 border-blue rounded-xl mt-16 form-border-gradient">
                    ...
                    <form action="#" method="POST" class="space-y-4 px-4 py-6">
                        ...
                        <div>
                            <select name="category_add" id="category_add" class="w-full text-sm rounded-xl bg-gray-100 border-none px-4 py-2">
