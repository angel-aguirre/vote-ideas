<div class="idea-container hover:shadow-card transition duration-150 ease-in bg-white rounded-xl flex cursor-pointer"
        ...
        <div class="mt-8">
            @if ($hasVoted)
                <button 
                    ...
                    class="w-20 text-white bg-blue border border-blue hover:bg-blue-hover transition duration-150 ease-in font-bold text-xxs uppercase rounded-xl px-4 py-3">
                    Voted
                </button>
            @else
                <button 
    ...
    <div class="flex flex-col md:flex-row flex-1 px-2 py-6">
        ...
        <div class="flex flex-col justify-between mx-4 w-full">
